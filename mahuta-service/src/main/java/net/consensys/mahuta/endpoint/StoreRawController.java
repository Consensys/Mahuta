...
public class StoreRawController {
     ...
     * @return IPFS hash
     */
    @RequestMapping(value = "${mahuta.api-spec.persistence.raw.store}", method = RequestMethod.POST, consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
     ...
     */
    @RequestMapping(value = "${mahuta.api-spec.persistence.raw.index}", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @throws ValidationException
     */
    @RequestMapping(value = "${mahuta.api-spec.persistence.raw.store_index}", method = RequestMethod.POST, consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
