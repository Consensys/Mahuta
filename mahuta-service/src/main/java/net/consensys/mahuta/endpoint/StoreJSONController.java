...
import net.consensys.mahuta.dto.json.JSONIndexRequest;
...
public class StoreJSONController {
     ...
     * @return IPFS hash
     */
    @RequestMapping(value = "${mahuta.api-spec.persistence.json.store}", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
     ...
     */
    @RequestMapping(value = "${mahuta.api-spec.persistence.json.index}", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @throws ValidationException
     */
    @RequestMapping(value = "${mahuta.api-spec.persistence.json.store_index}", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
