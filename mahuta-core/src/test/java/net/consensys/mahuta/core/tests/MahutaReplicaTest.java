...
//
//public class MahutaReplicaTest extends MahutaTestAbstract {
//
...
//        ContainerUtils.startContainer("ipfs-cluster1", ContainerType.IPFS_CLUSTER, 
//                ImmutableMap.of("IPFS_API", "/ip4/"+ContainerUtils.getHost("ipfs-replica1")+"/tcp/"+ContainerUtils.getPort("ipfs-replica1")));
//        ContainerUtils.startContainer("ipfs-cluster2", ContainerType.IPFS_CLUSTER, 
//                ImmutableMap.of("IPFS_API", "/ip4/"+ContainerUtils.getHost("ipfs-replica2")+"/tcp/"+ContainerUtils.getPort("ipfs-replica2")));
//    }
//    
//    @AfterClass
...
//                         .addReplica(IPFSClusterPinningService.connect(ContainerUtils.getHost("ipfs-cluster1"), ContainerUtils.getPort("ipfs-cluster1")))
//                         .addReplica(IPFSClusterPinningService.connect(ContainerUtils.getHost("ipfs-cluster2"), ContainerUtils.getPort("ipfs-cluster2")))
//        );
