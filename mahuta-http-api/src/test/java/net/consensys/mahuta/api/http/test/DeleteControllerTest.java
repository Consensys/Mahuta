...
public class DeleteControllerTest extends WebTestUtils {
    ...
    public void deleteById() throws Exception {
        ...
        mockMvc.perform(get("/query/fetch/"+requestAndMetadata.getMetadata().getContentId()))
                .andDo(print())
    ...
    public void deleteByHash() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/delete/hash/"+requestAndMetadata.getMetadata().getContentId())
                .param("index", request.getIndexName()))
                .andDo(print())
                .andExpect(status().isOk())
                .andReturn();
