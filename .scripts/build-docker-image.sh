...
if [[ -v VERSION ]]; then
    ...
    docker build -t gjeanmart/mahuta:${VERSION} -f mahuta-service/mahuta-http-api/Dockerfile .
    docker build -t gjeanmart/mahuta:${TYPE} -f mahuta-service/mahuta-http-api/Dockerfile .
