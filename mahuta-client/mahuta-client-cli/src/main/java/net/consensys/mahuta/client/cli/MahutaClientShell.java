...
import net.consensys.mahuta.client.cli.model.ClientShellException;
...
/**
 * Mahuta Client - Command Line Interface
 *
 * @author Gregoire Jeanmart <gregoire.jeanmart@consensys.net>
 */
@ShellComponent
@Slf4j
public class MahutaClientShell {
    ...
    public String store(
            ...
            @ShellOption(value = ARGS_INPUT) String input) throws MahutaException {

        MahutaClient client = getClient(host, port);
    ...
    public String index(
        ...
        if (!input.equals(NULL)) {
            ...
            } catch (IOException | MahutaException e) {
    ...
    private static MahutaClient getClient(String host, Integer port) {
        return new MahutaClient("http://" + host + ":" + port);
    }
